...
def test_get_all_posts(authorized_client, test_posts):
    ...
    #This line of code validates the results as the PostOut pydantic model
    def validate(post):
...
@pytest.mark.parametrize("title, content, published", [
    ("awesome", "not awesome", True),
    ("Jhon xina", "the best fighter ever", False),
    ("What ruined my life", "nothing, it's a joke", True),
])
